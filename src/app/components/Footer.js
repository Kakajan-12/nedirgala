...
export default function Footer() {
    ...
    return (
        <footer className="text-[#272727] text-[18px] mt-8 bg-[#272727]">
            <div className="px-4 container mx-auto ">
                <div className="grid text-white">
                    <div className="grid md:grid-cols-2 xl:grid-cols-4 py-10 md:px-8 px-4 gap-4">
                        <div className="grid content-start gap-1 md:gap-8">
                            <div className="bg-white flex items-center p-2 w-fit">
                                <img
